...
setwd('//snow/projects/RaBET/RaBET_species/NEON_SRER/2021/hdf5')
...
#imglist <- list("\\\\snow\\2021\\FullSite\\D14\\2021_SRER_3\\L3\\Spectrometer\\Reflectance\\NEON_D14_SRER_DP3_515000_3519000_reflectance.h5")
...
for(f in imglist){
  ...
  # writeRaster(rasterstack,
  #             file= paste(substr(f,1,nchar(f)-3), "bands_all_2021", sep='_'),
  #             format="GTiff",
  #             overwrite=TRUE)
    
  writeRaster(rasterstack,
              file= paste(substr(f,1,nchar(f)-3), "39_bands_nonoise_2021", sep='_'),
              format="GTiff",
              overwrite=TRUE)
